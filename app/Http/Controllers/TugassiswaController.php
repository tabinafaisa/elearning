...
class TugassiswaController extends Controller
{
    ...
    public function detail($kelas_id){
        ...
        $siswa = Tugassiswa::select('tugas_siswa.*', 'siswa.nama as nama_siswa', 'tugas.judul')->join('siswa', 'tugas_siswa.siswa_id', '=', 'siswa.id')->join('tugas', 'tugas_siswa.tugas_id', 'tugas.id')->where('tugas.kelas_id', $kelas_id)->get();
        // return $siswa_id;
