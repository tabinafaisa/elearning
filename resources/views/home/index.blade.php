 ...
 <main>
            ...
            <div class="slider__active swiper-container">
               <div class="swiper-wrapper">
                  <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
                     <div class="slider__bg slider__overlay include-bg" data-background="{{asset('/')}}img/slider/slider-1.jpg"></div>
                     <div class="container">
                        <div class="row">
                  ...
                  <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
                     <div class="slider__bg slider__overlay include-bg" data-background="{{asset('/')}}img/slider/slider-2.jpg"></div>
                     <div class="container">
                        <div class="row">
                  ...
                  <div class="col-xxl-7 col-xl-7 col-lg-7">
                     <div class="about__thumb-wrapper d-sm-flex mr-20 p-relative">
                        <div class="about__shape">
                           <img class="about__shape-1 d-none d-sm-block" src="{{asset('/')}}img/about/about-shape-1.png" alt="">
                           <img class="about__shape-2 d-none d-sm-block" src="{{asset('/')}}img/about/about-shape-2.png" alt="">
                           <img class="about__shape-3" src="{{asset('/')}}img/about/about-shape-3.png" alt="">
                        </div>
               ...
               <div class="row">
                     ...
                     <div class="course__item white-bg transition-3 mb-30">
                        <div class="course__thumb w-img fix">
                           <a href="course-details.html">
                              <img src="{{asset('/')}}img/course/course-1.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content p-relative">
                           ...
                           <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                              <div class="course__tutor">
                                 <a href="#"><img src="{{asset('/')}}img/course/tutor/course-tutor-1.jpg" alt="">Brian Cumin</a>
                              </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        <div class="course__thumb w-img fix">
                           <a href="course-details.html">
                              <img src="{{asset('/')}}img/course/course-2.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content p-relative">
                           <div class="course__price">
                           ...
                           <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                              <div class="course__tutor">
                                 <a href="#"><img src="{{asset('/')}}img/course/tutor/course-tutor-2.jpg" alt="">Jack Morkel</a>
                              </div>
                              <div class="course__lesson">
                                 <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 12.2V4.49999C1 1.7 1.70588 1 4.52941 1H9.47059C12.2941 1 13 1.7 13 4.49999V11.5C13 11.598 13 11.696 12.9929 11.794" stroke="#49535B" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        <div class="course__thumb w-img fix">
                           <a href="course-details.html">
                              <img src="{{asset('/')}}img/course/course-3.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content p-relative">
                           <div class="course__price">
                           ...
                           <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                              <div class="course__tutor">
                                 <a href="#"><img src="{{asset('/')}}img/course/tutor/course-tutor-3.jpg" alt="">Hilary Ouse</a>
                              </div>
                              <div class="course__lesson">
                                 <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 12.2V4.49999C1 1.7 1.70588 1 4.52941 1H9.47059C12.2941 1 13 1.7 13 4.49999V11.5C13 11.598 13 11.696 12.9929 11.794" stroke="#49535B" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        <div class="course__thumb w-img fix">
                           <a href="course-details.html">
                              <img src="{{asset('/')}}img/course/course-4.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content p-relative">
                           <div class="course__price">
                           ...
                           <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                              <div class="course__tutor">
                                 <a href="#"><img src="{{asset('/')}}img/course/tutor/course-tutor-4.jpg" alt="">Phanta Bear</a>
                              </div>
                              <div class="course__lesson">
                                 <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 12.2V4.49999C1 1.7 1.70588 1 4.52941 1H9.47059C12.2941 1 13 1.7 13 4.49999V11.5C13 11.598 13 11.696 12.9929 11.794" stroke="#49535B" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        <div class="course__thumb w-img fix">
                           <a href="course-details.html">
                              <img src="{{asset('/')}}img/course/course-5.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content p-relative">
                           <div class="course__price">
                           ...
                           <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                              <div class="course__tutor">
                                 <a href="#"><img src="{{asset('/')}}img/course/tutor/course-tutor-5.jpg" alt="">Hilary Ouse</a>
                              </div>
                              <div class="course__lesson">
                                 <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 12.2V4.49999C1 1.7 1.70588 1 4.52941 1H9.47059C12.2941 1 13 1.7 13 4.49999V11.5C13 11.598 13 11.696 12.9929 11.794" stroke="#49535B" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item white-bg transition-3 mb-30">
                        <div class="course__thumb w-img fix">
                           <a href="course-details.html">
                              <img src="{{asset('/')}}img/course/course-6.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content p-relative">
                           <div class="course__price">
                           ...
                           <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                              <div class="course__tutor">
                                 <a href="#"><img src="{{asset('/')}}img/course/tutor/course-tutor-6.jpg" alt="">Oliver Porter</a>
                              </div>
                              <div class="course__lesson">
                                 <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 12.2V4.49999C1 1.7 1.70588 1 4.52941 1H9.47059C12.2941 1 13 1.7 13 4.49999V11.5C13 11.598 13 11.696 12.9929 11.794" stroke="#49535B" stroke-linecap="round" stroke-linejoin="round"/>
               ...
               <div class="row grid">
                  ...
                  <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 grid-item">
                     <div class="campus__thumb w-img mb-30">
                        <img src="{{asset('/')}}img/campus/campus-2.jpg" alt="">
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
                     <div class="campus__thumb w-img mb-25">
                        <img src="{{asset('/')}}img/campus/campus-3.jpg" alt="">
                     </div>
                  </div> 
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 grid-item">
                     <div class="campus__thumb w-img mb-30">
                        <img src="{{asset('/')}}img/campus/campus-1.jpg" alt="">
                     </div>
                  </div>  
                  <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
                     <div class="campus__thumb w-img mb-30">
                        <img src="{{asset('/')}}img/campus/campus-4.jpg" alt="">
                     </div>
                  </div>               
               </div>
            </div>
         ...
         <section class="research__area research__border grey-bg-3 pt-115 pb-90 p-relative z-index-1">
            <div class="research__shape">
               <img class="research__shape-1 d-none d-sm-block" src="{{asset('/')}}img/research/research-shape-1.png" alt="">
               <img class="research__shape-2 d-none d-sm-block" src="{{asset('/')}}img/research/research-shape-2.png" alt="">
               <img class="research__shape-3" src="{{asset('/')}}img/research/research-shape-3.png" alt="">
            </div>
            <div class="container">
               <div class="row">
                  <div class="col-xxl-12">
               ...
               <div class="row">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="research__item research__item-border text-center mb-30 transition-3">
                        <div class="research__thumb mb-35">
                           <img src="{{asset('/')}}img/research/research-1.jpg" alt="">
                        </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="research__item research__item-border active text-center mb-30 transition-3">
                        <div class="research__thumb mb-35">
                           <img src="{{asset('/')}}img/research/research-2.jpg" alt="">
                        </div>
                        <div class="research__content">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="research__item text-center mb-30 transition-3">
                        <div class="research__thumb mb-35">
                           <img src="{{asset('/')}}img/research/research-3.jpg" alt="">
                        </div>
                        <div class="research__content">
         ...
         <section class="blog__area pt-120 pb-85 p-relative">
            <div class="blog__shape">
               <img class="blog__shape-1" src="{{asset('/')}}img/blog/blog-shape-1.png" alt="">
               <img class="blog__shape-2" src="{{asset('/')}}img/blog/blog-shape-2.png" alt="">
               <img class="blog__shape-3" src="{{asset('/')}}img/blog/blog-shape-3.png" alt="">
               <img class="blog__shape-4" src="{{asset('/')}}img/blog/blog-shape-4.png" alt="">
            </div>
            <div class="container">
               <div class="row">
                  <div class="col-xxl-12">
               ...
               <div class="row">
                  <div class="col-xxl-6 col-xl-6">
                     <div class="blog__item-float blog__item-float-overlay p-relative fix transition-3 mb-30 d-flex align-items-end">
                        <div class="blog__thumb-bg w-img fix" data-background="{{asset('/')}}img/blog/blog-1.jpg"></div>
