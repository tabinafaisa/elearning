                ...
                <div class="row">
                    <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-5 offset-lg-1 col-md-6">
                        <div class="contact__item text-center mb-30 transition-3 white-bg">
                            ...
                            <div class="contact__content">
                                <h3 class="contact__title">Daftar Sebagai Guru</h3>
                                <a href="{{ url('/register/guru') }}" class="tp-btn tp-btn-border">Klik Disini</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-5 col-xl-5  col-lg-5 col-md-6">
                        <div class="contact__item text-center mb-30 transition-3 white-bg">
                            ...
                            <div class="contact__content">
                                <h3 class="contact__title">Daftar Sebagai Siswa</h3>
                                <a href="{{ url('/register/siswa') }}" class="tp-btn tp-btn-border">Klik Disini</a>
                            </div>
                        </div>
                    </div>
                </div>
